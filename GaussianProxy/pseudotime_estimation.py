...
def get_sort_func(ds: DataSet, label):
    """
...
if __name__ == "__main__":
    ...
    from my_conf import my_pseudotime_conf
    from my_conf.my_pseudotime_conf import params

    # Snapshot the config file content once at startup
    config_snapshot = Path(my_pseudotime_conf.__file__).read_text(encoding="utf-8")
    config_filename = Path(my_pseudotime_conf.__file__).name
