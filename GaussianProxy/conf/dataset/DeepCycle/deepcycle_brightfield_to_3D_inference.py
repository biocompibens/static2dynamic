...
ds_params = DatasetParams(
    ...
    dataset_class=partial(TIFFDatasetSelectChannelsTo3D, selected_channels_with_repeats=(3, 3, 3)),  # pyright: ignore[reportArgumentType]
)

dataset = DataSet(
    name="deepcycle_brightfield_to_3D",
